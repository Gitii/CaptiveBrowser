...
public class Socks5Server
{
    ...
    private Thread NetworkStats = null!;
    ...
    void _server_onClientConnected(object sender, ClientEventArgs e)
    {
        ...
        foreach (
            ClientConnectedHandler cch in PluginLoader.GetPluginsOfType<ClientConnectedHandler>()
        )
        {
            try
            {
    ...
    void client_onClientDisconnected(object sender, SocksClientEventArgs e)
    {
        ...
        foreach (
            ClientDisconnectedHandler cdh in PluginLoader.GetPluginsOfType<ClientDisconnectedHandler>()
        )
        {
            try
            {
