...
public class SocksClient
{
    ...
    public int Authenticated { get; private set; } = 0;
    ...
    public SocksRequest? Destination
    {
        get { return req1; }
    }
    ...
    public void Begin(IPAddress outboundInterface, int PacketSize, int Timeout)
    {
        ...
        var lhandlers = PluginLoader.GetPluginsOfType<LoginHandler>().ToList();
        ...
        if (Authenticated == 1)
        {
            ...
            foreach (ConnectHandler conn in PluginLoader.GetPluginsOfType<ConnectHandler>())
            {
