...
public class Stats
{
    ...
    {
        get { return rc.GetPerSecondNumeric(); }
    }

    public ulong BytesSentPerSec
    {
        get { return sc.GetPerSecondNumeric(); }
    }

    //per sec.
    public string SBytesReceivedPerSec
    {
        get { return rc.GetPerSecond(); }
    }

    public string SBytesSentPerSec
    {
